...
## [0.29.0](https://github.com/canonical/identity-platform-login-ui/compare/v0.28.0...v0.29.0) (2026-09-25)


### Features

* **ci:** shift-left vulnerability check & release quarantine gate ([43de0d5](https://github.com/canonical/identity-platform-login-ui/commit/43de0d5a2e50f219d544a67bc5c7bf5a75284aae))
* **ci:** shift-left vulnerability check & release quarantine gate ([#979](https://github.com/canonical/identity-platform-login-ui/issues/979)) ([7cb6c1c](https://github.com/canonical/identity-platform-login-ui/commit/7cb6c1c82ba26977586f13aa5b08bf85901083d8))
* support the RFC 8707 resource parameter ([f3b9a61](https://github.com/canonical/identity-platform-login-ui/commit/f3b9a6153b52153e8d595c24ec2155b8c5a3bcc1)), closes [#966](https://github.com/canonical/identity-platform-login-ui/issues/966)
* support the RFC 8707 resource parameter ([#974](https://github.com/canonical/identity-platform-login-ui/issues/974)) ([e3c3e7c](https://github.com/canonical/identity-platform-login-ui/commit/e3c3e7c6c81b174697b901b16f3e1d7d90c69156)), closes [#966](https://github.com/canonical/identity-platform-login-ui/issues/966)
...
* address CVEs ([58c5643](https://github.com/canonical/identity-platform-login-ui/commit/58c5643d3acbe272baf5af136713bf33b25b9418)), closes [#911](https://github.com/canonical/identity-platform-login-ui/issues/911)
* address CVEs ([#972](https://github.com/canonical/identity-platform-login-ui/issues/972)) ([4f1a46e](https://github.com/canonical/identity-platform-login-ui/commit/4f1a46ed4e25555e25abcfc0e07495165a1ca94b)), closes [#911](https://github.com/canonical/identity-platform-login-ui/issues/911)
...
* **kratos:** forward only 4xx generic errors and guard login 400 handling ([c3ebe5e](https://github.com/canonical/identity-platform-login-ui/commit/c3ebe5efe2d61b5f75d18de5162a324e51348fc8))
...
* add custom password input field with error before helptext ([7f6595a](https://github.com/canonical/identity-platform-login-ui/commit/7f6595a6b1efb57aea123039d4b3b05dddb1412f))
* add password error styles to input text ([33a82af](https://github.com/canonical/identity-platform-login-ui/commit/33a82af3dbb031f7bb8b1c7b7114d5b0cbc21697))
...
* **frontend:** add page for options to secure account ([e7a13b8](https://github.com/canonical/identity-platform-login-ui/commit/e7a13b8e88f5b62054abfd18adda2307575596b0))
* **frontend:** donot show error while user is editing the password in password confirmation screen ([992308d](https://github.com/canonical/identity-platform-login-ui/commit/992308dcf6035c868956681a028be0eebc25ba58))
* **frontend:** first draft of registration flow ([0f8131e](https://github.com/canonical/identity-platform-login-ui/commit/0f8131e444c3286868ef5ca38647cb270764aefb))
...
* **frontend:** include basePath in next config and replace browser redirects with next redirects. Incorporates some copilot suggestions as well ([981b36d](https://github.com/canonical/identity-platform-login-ui/commit/981b36d2dbef695e181a5ed58f85b356691e32b3))
* **frontend:** registration flow redirects to verification flow correctly ([774963b](https://github.com/canonical/identity-platform-login-ui/commit/774963b501d7987d870c8c15c5579ae1fadf21cc))
* identifier first login, reset password overhaul ([9369656](https://github.com/canonical/identity-platform-login-ui/commit/936965683e76701d2c55e88150687de6bb6c4b93))
* identifier first login, reset password overhaul ([#759](https://github.com/canonical/identity-platform-login-ui/issues/759)) ([b8f9aee](https://github.com/canonical/identity-platform-login-ui/commit/b8f9aee92dcef92654a91a8d01d3d6a4c1ba58ae))
...
* redirect to secure_account after verification is successful ([d50907b](https://github.com/canonical/identity-platform-login-ui/commit/d50907ba8fa16ef8b08852c3c91c1cdd0dc2e7ca))
...
* support verification on login ([e6c01d8](https://github.com/canonical/identity-platform-login-ui/commit/e6c01d8206d2799f1c23dfbc14c9c733aba2f471))
...
* **ui:** add email auto-submit and login redirect to verification flow ([bcea71d](https://github.com/canonical/identity-platform-login-ui/commit/bcea71de46d1269abb3a1abfe5a9bb1d95f671ab))
* **ui:** continue with verification after registration ([9203dee](https://github.com/canonical/identity-platform-login-ui/commit/9203dee38d1d4fb3e6746ce03defcca7d2bbe27f))
...
* update login e2e tests ([8cb248e](https://github.com/canonical/identity-platform-login-ui/commit/8cb248ebec872b95b4d89ef0932fa0a046fdd48d))
...
* add flow error handler in register password view ([#882](https://github.com/canonical/identity-platform-login-ui/issues/882)) ([6616fa4](https://github.com/canonical/identity-platform-login-ui/commit/6616fa42ebc32737d434d7e0379d34dde8a7aef8))
* avoid query param passing (with flow param) when switching flows ([82d2a54](https://github.com/canonical/identity-platform-login-ui/commit/82d2a5435298d70de5866b60c22e282372c36493))
* avoid query param passing (with flow param) when switching flows ([#889](https://github.com/canonical/identity-platform-login-ui/issues/889)) ([946ae37](https://github.com/canonical/identity-platform-login-ui/commit/946ae37c033649590631beb3df9b33a11712cf96)), closes [#874](https://github.com/canonical/identity-platform-login-ui/issues/874)
* **deps:** update module go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp to v1.43.0 [security] ([405da51](https://github.com/canonical/identity-platform-login-ui/commit/405da51b0fcbdede7ca6a982a86c210e00f0b1ee))
* **deps:** update module go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp to v1.43.0 [security] ([#870](https://github.com/canonical/identity-platform-login-ui/issues/870)) ([7ba39f9](https://github.com/canonical/identity-platform-login-ui/commit/7ba39f93d525396f4df1d7af2c4b0e7023200d07))
...
* display error with seconds in countdown text ([2ff4f76](https://github.com/canonical/identity-platform-login-ui/commit/2ff4f7692ef13fcba7a1c7d6d54bfc063f7e1866))
* display error with seconds in countdown text ([#878](https://github.com/canonical/identity-platform-login-ui/issues/878)) ([6a4ed7b](https://github.com/canonical/identity-platform-login-ui/commit/6a4ed7bbcc80417875f5b631bc82d924c6cb7eb9))
* double substring in url + image not rendering ([7ae390a](https://github.com/canonical/identity-platform-login-ui/commit/7ae390adcb420b709695feb58ae952fed6f8847d))
* double update of loginflow ([adc3eb2](https://github.com/canonical/identity-platform-login-ui/commit/adc3eb29ae9f3cf6af28d0c5a976424f7c2eb3eb))
* duplicate buttons in flow ([c92d3c1](https://github.com/canonical/identity-platform-login-ui/commit/c92d3c1ca97ef8abdea9356120658c6d21b97f98))
* **frontend:** Password checks are not debounced and show errors on blur ([d655754](https://github.com/canonical/identity-platform-login-ui/commit/d65575465539b39e0a24f0a1c500584708d32c14))
* **frontend:** replace /ui paths with basepath from router and remove returnTo from verification flow ([f412020](https://github.com/canonical/identity-platform-login-ui/commit/f412020b4f3b1be9592a3e104cf4c59c8703e98d))
* **frontend:** revert verification return_to url param, obscure secure_account page and remove it from verification flow ([6b43c4b](https://github.com/canonical/identity-platform-login-ui/commit/6b43c4b6fd731d41f58e8c7fd9c3bfdc0ffdc5c9))
* **frontend:** use default password toggle component but with custom error messaging ([29b9240](https://github.com/canonical/identity-platform-login-ui/commit/29b9240080b58f7cd128a8abd0a3019595e67072))
* **frontend:** use setflow to handle errors in registerpassword component ([b19fd39](https://github.com/canonical/identity-platform-login-ui/commit/b19fd3971f6fbd8811f4822ba950feeebed868d3))
* handle missing flow ID + use proper context object from http request ([013f009](https://github.com/canonical/identity-platform-login-ui/commit/013f0091ed22c66f03bc10b2965c0500d167dc8d))
* linting and update ([2c8cb8e](https://github.com/canonical/identity-platform-login-ui/commit/2c8cb8e2227a527fa95fa7a161270f695741afd8))
* **mail:** remove verification link from verification email ([73a3df4](https://github.com/canonical/identity-platform-login-ui/commit/73a3df489314d2e44a9457bd6c018a79b4aef4fd))
* **mail:** remove verification link from verification email ([#876](https://github.com/canonical/identity-platform-login-ui/issues/876)) ([cb5a1ee](https://github.com/canonical/identity-platform-login-ui/commit/cb5a1eef6e48098ebae1923d8ad2f5a6e1c7c2c3))
* move reset password button to below the password field on login ([b5270b0](https://github.com/canonical/identity-platform-login-ui/commit/b5270b0bbb898771c282c75765aabac1baac6b09))
* NodeImage missing height and width ([33fcd67](https://github.com/canonical/identity-platform-login-ui/commit/33fcd67d716fd12c87d0ce3391a6d54895363e91))
...
* remove all back buttons ([925b2f0](https://github.com/canonical/identity-platform-login-ui/commit/925b2f03a35e36f16d867cf8dee6a44b3acd29ab))
...
* restore download button ([9e67294](https://github.com/canonical/identity-platform-login-ui/commit/9e6729470155cb31e15f3a3af64c27cfd398ddcc))
...
* strip /api/kratos ([5e33aaa](https://github.com/canonical/identity-platform-login-ui/commit/5e33aaa3247e268296b03724bcb5e71e419f0dc8))
* **ui:** add flow error handler in register password component ([b1d8e38](https://github.com/canonical/identity-platform-login-ui/commit/b1d8e387d32b6deeafa2386e14661814e3941077))
* **ui:** handle upstream errors coming from flow object in input email node ([f4d78d5](https://github.com/canonical/identity-platform-login-ui/commit/f4d78d5194457f42b1df1c391c729ccaa999a191))
* **ui:** handle upstream errors coming from flow object in node input text ([8c49fbe](https://github.com/canonical/identity-platform-login-ui/commit/8c49fbe0b057b8682f6ce6f0e6e267cccf831503))
* **ui:** include copilot suggestions for fixing errors ([39c1869](https://github.com/canonical/identity-platform-login-ui/commit/39c18699b35fc8e4984ab7a22e721b90e7b22e6d))
* **ui:** optimize redirectTo external urls and build url to login ui more intuitively ([47c6103](https://github.com/canonical/identity-platform-login-ui/commit/47c6103fc958ca0b0dcb99e89f27061190217bab))
* **ui:** set correct register url ([680ec35](https://github.com/canonical/identity-platform-login-ui/commit/680ec352d20c1cf67a92a3bc2e64f45a9c36536a))
* uniform error messages strings by capitalizing first letter ([4f680a1](https://github.com/canonical/identity-platform-login-ui/commit/4f680a1b0b2ccfa7ecc45140dc70fd6ef6aea91d))
* unmarshaling error with existing session ([c4c4764](https://github.com/canonical/identity-platform-login-ui/commit/c4c476485a0ba5de8d4ec7fde0b568028a72b04c))
* unmarshaling error with existing session ([#877](https://github.com/canonical/identity-platform-login-ui/issues/877)) ([b67ee2e](https://github.com/canonical/identity-platform-login-ui/commit/b67ee2e51aecc23d1131cdb27e65c182120bb4fd)), closes [#863](https://github.com/canonical/identity-platform-login-ui/issues/863)
* Update redirectTo to accept external URLs ([da09eba](https://github.com/canonical/identity-platform-login-ui/commit/da09ebab354bd5b7df83b5024fee448e508bc3e8))
* use redirectTo function for next router redirects ([fdcec5a](https://github.com/canonical/identity-platform-login-ui/commit/fdcec5a8c270aff7448755b0fb5e90ee46970bbb))
* wrong error display in input field ([ff7ac0a](https://github.com/canonical/identity-platform-login-ui/commit/ff7ac0a720205256828fcdfb42dddcb68557ceae))
