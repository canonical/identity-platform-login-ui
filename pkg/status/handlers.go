...
func NewAPI(baseURL string, supportEmail string, oidcWebAuthnSequencingEnabled bool, identifierFirstEnabled bool, service ServiceInterface, tracer tracing.TracingInterface, monitor monitoring.MonitorInterface, logger logging.LoggerInterface) *API {
	a := new(API)
