...
func TestService_tryProcessingRegistration(t *testing.T) {
	...
	t.Run("Status 200 - successful registration", func(t *testing.T) {
		body := kClient.SuccessfulNativeRegistration{
		...
		if reg == nil || reg.completedFlow == nil {
			t.Fatalf("expected completedFlow, got nil")
		}
	})
