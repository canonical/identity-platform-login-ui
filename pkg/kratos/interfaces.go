...
type ServiceInterface interface {
	...
	CreateBrowserRegistrationFlow(context.Context, string, []*http.Cookie) (*kClient.RegistrationFlow, []*http.Cookie, error)
	...
	UpdateRegistrationFlow(context.Context, string, kClient.UpdateRegistrationFlowBody, []*http.Cookie) (*kClient.SuccessfulNativeRegistration, []*http.Cookie, error)
