...
func (s *Service) CreateVerificationFlow(ctx context.Context, cookies []*http.Cookie) (*kClient.VerificationFlow, []*http.Cookie, error) {
    ctx, span := s.tracer.Start(ctx, "kratos.Service.CreateVerificationFlow")
    defer span.End()
