...
func (a *API) handleCreateFlow(w http.ResponseWriter, r *http.Request) {
	...
	if session != nil {
		...
		if err != nil {
			a.logger.Errorf("Failed check for verification: %v", err)
		...
		if shouldEnforceVerification {
			...
			a.verificationSettingsRedirect(w, r, returnTo, flowCookie, unverifiedEmail)
			return
		}
...
func (a *API) handleUpdateFlow(w http.ResponseWriter, r *http.Request) {
	...
	if shouldEnforceVerification {
        ...
        a.verificationSettingsRedirect(w, r, *loginFlow.ReturnTo, flowCookie, unverifiedEmail)
        return
    }
...
func (a *API) verificationSettingsRedirect(w http.ResponseWriter, r *http.Request, returnTo string, flowStateCookie FlowStateCookie, email string) {
