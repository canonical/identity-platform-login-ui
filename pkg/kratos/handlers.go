...
func (a *API) handleUpdateFlow(w http.ResponseWriter, r *http.Request) {
	...
	if redirectTo != nil {
		...
		a.backchannelRedirectResponse(w, r, redirectTo)
		return
	}
	...
	if lc != "" {
		...
		a.cookieManager.ClearStateCookie(w)
		setCookies(w, cookies)
		a.backchannelRedirectResponse(w, r, response)
		return
	}
...
func (a *API) backchannelRedirectResponse(w http.ResponseWriter, r *http.Request, resp RedirectTo) {
	switch r.Method {
	case "GET":
...
func (a *API) webAuthnSettingsRedirect(w http.ResponseWriter, r *http.Request, returnTo string, flowStateCookie FlowStateCookie) {
	...
	a.backchannelRedirectResponse(w, r, &ErrorBrowserLocationChangeRequired{
