...
type EnvSpec struct {
    ...
    FeatureFlags                  []string `envconfig:"feature_flags" default:"password,webauthn,backup_codes,totp,account_linking" validate:"dive,oneof=password webauthn backup_codes totp account_linking"`
